...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set MUX_EN [ create_bd_port -dir O -from 9 -to 0 MUX_EN ]
  set MUX_SEL [ create_bd_port -dir O -from 29 -to 0 MUX_SEL ]
  ...
  # Create instance: PmodAD2_1, and set properties
  set PmodAD2_1 [ create_bd_cell -type ip -vlnv digilentinc.com:IP:PmodAD2:1.0 PmodAD2_1 ]
  set_property -dict [ list \
   CONFIG.PMOD {jb} \
   CONFIG.USE_BOARD_FLOW {true} \
 ] $PmodAD2_1
  ...
  connect_bd_intf_net -intf_net PmodAD2_0_Pmod_out [get_bd_intf_ports ja] [get_bd_intf_pins PmodAD2_0/Pmod_out]
  connect_bd_intf_net -intf_net PmodAD2_1_Pmod_out [get_bd_intf_ports jb] [get_bd_intf_pins PmodAD2_1/Pmod_out]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins PmodAD2_0/AXI_LITE_IIC] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins PmodAD2_1/AXI_LITE_IIC] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  ...
  connect_bd_net -net axi_gpio_1_gpio2_io_o [get_bd_ports MUX_EN] [get_bd_pins axi_gpio_1/gpio2_io_o]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports MUX_SEL] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PmodAD2_0/s_axi_aclk] [get_bd_pins PmodAD2_1/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins PmodAD2_0/s_axi_aresetn] [get_bd_pins PmodAD2_1/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PmodAD2_0/AXI_LITE_IIC/Reg0] -force
  assign_bd_address -offset 0x40001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PmodAD2_1/AXI_LITE_IIC/Reg0] -force
